                        ...
                        <form method="POST" action="{{ route('admin.pagos.generarCobro') }}" target="QrImage">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
                                <div class="flex flex-col">
                                    ...
                                    <select id="user_id" name="tcUserId"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="flex flex-col">
                                    ...
                                    <x-text-input type="text" required name="tcRazonSocial" :value="__('Gupo04-SA')"
                                        class="border p-2 rounded-md " readonly />
                                </div>
                                <div class="flex flex-col">
                                    <label class="px-3">CI/NIT</label>
                                    <x-text-input type="text" required name="tcCiNit" :value="__('7810344')"
                                        class="border p-2 rounded-md" required pattern="[0-9]*" required />
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="flex flex-col">
                                    ...
                                    <x-text-input type="text" required name="tnTelefono" :value="__('75540850')"
                                        class="border p-2 rounded-md" title="Ingresa solo números" pattern="[0-9]*"
                                        required />
                                </div>
                                <div class="flex flex-col">
                                    <label class="px-3">Correo</label>
                                    <x-text-input type="text" name="tcCorreo" :value="__('j.mario18npa@gmail.com')"
                                        class="border p-2 rounded-md" readonly />
                                </div>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="flex flex-col">
                                    ...
                                    <x-text-input type="number" name="tnMonto" :value="0.01"
                                        class="border p-2 rounded-md" readonly />
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="flex flex-col">
                                    ...
                                    <input type="text" required pattern="[0-9]*" id="taPedidoDetalle[0][Serial]"
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <x-text-input type="text" required name="taPedidoDetalle[0][Producto]"
                                        :value="old('nombre')" class="border p-2 rounded-md" required />
                                </div>
                                <div class="flex flex-col">
                                    <label class="px-3">Cantidad</label>
                                    <x-text-input type="number" required pattern="[0-9]*" title="Ingresa solo números"
                                        pattern="[0-9]*" required name="taPedidoDetalle[0][Cantidad]" :value="1"
                                        class="border p-2 rounded-md" title="Ingresa solo números" pattern="[0-9]*"
                                        required readonly />
                                </div>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div class="flex flex-col">
                                    ...
                                    <x-text-input type="number" required name="taPedidoDetalle[0][Precio]"
                                        :value="old('precio')" class="border p-2 rounded-md" required />
                                </div>
                                <div class="flex flex-col">
