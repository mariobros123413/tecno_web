    ...
    <div class="flex flex-wrap items-center justify-between ">
        <div class="flex items-center justify-center ">
            <div class="flex items-center justify-center text-3xl font-bold text-true-gray-800 dark:text-gray-100">
                <img src="https://obologistic.com/wp-content/uploads/2021/09/obo-logistic-LOGO-variaciones-de-color-16-2-e1707318780684.png"
                    alt="Logo" class="h-16 mr-2">
            </div>
                ...
                <div class="sm:flex">
                    @auth
                        <x-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')"
                            class="text-xl font-bold px-4 py-2 mx-2 sm:mx-10 {{ request()->routeIs('dashboard') ? 'text-blue-600' : 'text-gray-600' }}">
                            {{ __('Dashboard') }}
                        </x-nav-link>
                    @endauth
                </div>
            ...
            <div class=" flex items-center justify-center ">
                @auth
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <x-dropdown-link :href="route('logout')" class="text-xl font-bold  " onclick="event.preventDefault();
