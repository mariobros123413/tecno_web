...
<!-- Modal -->
<div id="qrModal" class="fixed inset-0 hidden bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center">
    <div class="bg-white rounded-lg p-4 relative w-96">
        <button onclick="closeModal()" class="absolute top-2 right-2 text-red-600 hover:text-red-800 text-xl font-bold">
            &times;
        </button>
