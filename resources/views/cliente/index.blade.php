            ...
            <div class="my-20 py-12 bg-white dark:bg-gray-800 rounded-xl" id="servicios">
                ...
                <div class="grid md:grid-cols-3 gap-8 mt-12">
                    ...
                    <div
                        ...
                        <div
                            class="flex items-center justify-center w-16 h-16 bg-blue-600 text-white rounded-full mb-4">
                    ...
                    <div
                        class="flex flex-col items-center text-center bg-gray-100 dark:bg-gray-700 p-6 rounded-lg shadow-md">
                        <div
                            class="flex items-center justify-center w-16 h-16 bg-green-600 text-white rounded-full mb-4">
                            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <p class="text-gray-600 dark:text-gray-300 mt-2">
                            Garantizamos la seguridad de tus paquetes durante todo el proceso de envío. Ofrecemos
                            seguros de
                            envío.
                        </p>
                    </div>
