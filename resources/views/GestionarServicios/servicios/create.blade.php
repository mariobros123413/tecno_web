        ...
        <form method="POST" action="{{ route('admin.servicio.store') }}">
            ...
            <div class="mt-4">
                ...
                <x-text-input id="descripcion" class="block mt-1 w-full" type="text" name="descripcion"
                    :value="old('descripcion')" required autocomplete="Descripcion del Servicio" />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-text-input id="precio_kilo" class="block mt-1 w-full" type="text" name="precio_kilo"
                    :value="old('precio_kilo')" required autocomplete="precio por Kilo" />
            </div>
